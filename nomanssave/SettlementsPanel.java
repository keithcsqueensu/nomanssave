...
public class SettlementsPanel extends JPanel {
   private FormPanel hv;
   private FormPanel hw;
   private JComboBox hx;
   private ValidatedTextField hy;
   private ValidatedTextField hz;
   private ValidatedTextField[] ea;
   private JTable hA;
   private dt hB;
   private SettlementState[] hC;

   SettlementsPanel(Application var1) {
      GridBagLayout var2 = new GridBagLayout();
      var2.columnWidths = new int[]{AppSettings.cI, 0, 0};
      var2.rowHeights = new int[1];
      var2.columnWeights = new double[]{0.0D, 0.0D, 1.0D};
      var2.rowWeights = new double[]{1.0D};
      this.setLayout(var2);
      this.hv = new FormPanel();
      ...
      this.hv.AboutDialog("Settlement", true, this.hx);
      this.hy = new dG(this);
      this.hv.AboutDialog("Name", (JComponent)this.hy);
      this.hz = new dH(this);
      this.hv.AboutDialog("Seed", this.hz);
      this.hv.Y();
      this.hv.k("Stats");
      this.ea = new ValidatedTextField[gG.values().length];

      for(int var4 = 0; var4 < this.ea.length; ++var4) {
         this.ea[var4] = new dM(this, gG.values()[var4], (dM)null);
         this.hv.AboutDialog(gG.values()[var4].toString(), (JComponent)this.ea[var4]);
      }

      this.hw = new FormPanel();
   ...
   // $FF: synthetic method
   static ValidatedTextField d(SettlementsPanel var0) {
      return var0.hz;
   }

   // $FF: synthetic method
   static ValidatedTextField[] e(SettlementsPanel var0) {
      return var0.ea;
   }

   // $FF: synthetic method
   static dt f(SettlementsPanel var0) {
      return var0.hB;
   }

   // $FF: synthetic method
   static JTable g(SettlementsPanel var0) {
      return var0.hA;
   }
}

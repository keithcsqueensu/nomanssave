...
public class AlienWord {
         ...
         try {
            ...
            for(int var4 = 0; var4 < var3.getLength(); ++var4) {
               ...
               if (var5 instanceof Element && var5.getNodeName().equals("word")) {
                  kq.add(new AlienWord((Element)var5));
               }
            }
   ...
   private AlienWord(Element var1) {
      ...
      for(int var3 = 0; var3 < var2.getLength(); ++var3) {
         ...
         Race var6 = Race.C(var4.getAttribute("race"));
         if (var6 != null) {
   ...
   public Race ShowErrorRunnable(String var1) {
   ...
   public static AlienWord ShowWarningRunnable(String var0) {
      Iterator var2 = kq.iterator();

      while(var2.hasNext()) {
         AlienWord var1 = (AlienWord)var2.next();
   ...
   public static AlienWord WindowCloseListener(String var0) {
      Iterator var2 = kq.iterator();
   ...
   public static AlienWord T(int var0) {
      return (AlienWord)kq.get(var0);
   }

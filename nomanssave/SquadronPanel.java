...
public class SquadronPanel extends SplitFormPanel {
   private ec[] ib;
   private SquadronPilot[] ic;
   private static final NpcType[] ie;

   static {
      ie = new NpcType[]{NpcType.qR, NpcType.qS, NpcType.qT};
   }

   SquadronPanel(Application var1) {
      GridBagLayout var2 = new GridBagLayout();
      var2.columnWidths = new int[]{AppSettings.cI, AppSettings.cI, AppSettings.cI, AppSettings.cI, 0};

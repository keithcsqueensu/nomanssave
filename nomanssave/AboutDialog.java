...
public class AboutDialog extends JDialog {
   ...
   private AboutDialog(Frame var1) {
      super(var1);
      ...
      this.getRootPane().registerKeyboardAction(new AboutDialogCloseListener(this), KeyStroke.getKeyStroke(27, 0), 2);
      this.pack();
   }

   public static void AboutDialog(Container var0) {
      if (AboutDialog == null) {
         Frame var1 = JOptionPane.getFrameForComponent(var0);
         AboutDialog = new AboutDialog(var1);
      }

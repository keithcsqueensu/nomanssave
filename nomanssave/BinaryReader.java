...
public class BinaryReader implements Closeable {
   ...
   public static Object parse(byte[] var0) {
      ...
      try {
         BinaryReader var3 = new BinaryReader(new ByteArrayInputStream(var0), 0);
   ...
   public BinaryReader(InputStream var1) {
      this(var1, 0);
   }

   public BinaryReader(InputStream var1, int var2) {
      this.in = var1;
      this.flags = var2;
      this.kR = -1;
   ...
   public void close() {
      try {
         ...
         if ((this.flags & 2) != 0) {
            if (this.kR != 0) {
               throw new JsonParseException("Missing null terminator");
            }
         ...
         if (this.kR >= 0) {
            throw new JsonParseException("Unexpected termination: " + this.kR);
         }
      } finally {
         if ((this.flags & 4) == 0) {
            this.in.close();
   ...
   public JsonObject readJsonObject(eG var1) {
      ...
      if (var2 < 0) {
         ...
         if (((JsonObject)var3).H("PlayerStateData") == null) {
            ((JsonObject)var3).AboutDialogCloseListener("PlayerStateData", (var0) -> {
      ...
      for(var1 = new ByteArrayOutputStream(); (var2 = this.read()) != 34; var1.write(var2)) {
         ...
         if (var2 == 92) {
            ...
            case 116:
               ...
               break;
            case 117:
               var2 = JsonParser.ae(this.read()) << 12 | JsonParser.ae(this.read()) << 8 | JsonParser.ae(this.read()) << 4 | JsonParser.ae(this.read());
               if (var2 > 255) {
                  throw new JsonParseException("Unexpected unicode escape: " + var2);
               }
            }
         }
      }

...
public class JsonParser {
   ...
   static boolean isSimpleValue(Class var0) {
      ...
      } else if (JsonArray.class.isAssignableFrom(var0)) {
         return true;
      } else {
   ...
   private static String toJsonArrayFiltered(JsonArray var0, String var1, boolean var2, Predicate var3) {
      ...
      for(int var5 = 0; var5 < var0.length; ++var5) {
         ...
         var4.append(AboutDialog(var0.values[var5], var1 == null ? null : var1 + "\t", var2, var3));
      }
   ...
   static JsonObject Q(String var0) {
      Throwable var1 = null;
      Object var2 = null;
   ...
   static JsonArray R(String var0) {
      Throwable var1 = null;
      Object var2 = null;
   ...
   private static String readKey(fi var0) {
      ...
      if (var1 instanceof String) {
         ...
         throw new JsonParseException("Invalid string", var0.kF, var0.kG);
      }
   }
   ...
   private static Object d(fi var0) {
      try {
            ...
            if (var3 == 92) {
               ...
               case 117:
                  ...
                  if (var3 <= 255) {
                     ...
                     if (var1 == null) {
                        throw new JsonParseException("Mixed encodings detected in string");
                     }
               ...
               case 120:
                  ...
                  if (var2 == null) {
                     throw new JsonParseException("Mixed encodings detected in stringx");
                  }
         ...
         throw new JsonParseException("Invalid string", var5, var0.kF, var0.kG);
      }
   }
   ...
   private static fg e(fi var0) {
      ...
      if (var0.read() != 48) {
         throw new JsonParseException("Invalid hex data", var0.kF, var0.kG);
   ...
   static void i(Object var0) {
      if (var0 instanceof JsonObject) {
         ((JsonObject)var0).kD = null;
      }

      if (var0 instanceof JsonArray) {
         ((JsonArray)var0).kD = null;
      }

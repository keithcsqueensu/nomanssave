...
class SteamSaveFileMetadata {
   ...
   SteamSaveFileMetadata(SteamSaveLocation var1, String var2, int var3, boolean var4) {
      this.mt = var1;
      this.filename = var2;
      this.lO = var3;
      if (var4) {
         FileInputStream var5 = new FileInputStream(new File(SteamSaveLocation.AboutDialog(var1), "mf_" + var2));

         int var7;
         try {
            Logger.info("Reading metadata for " + var2);
            byte[] var6 = new byte[1024];
            var7 = var5.read(var6);
            this.mx = SaveFileMetadata.AboutDialog(var3, var6, 0, var7);
         } finally {
            var5.close();
         }
         ...
         if (var11 != 0) {
            Logger.debug("  DecompressedSize: " + var11);
         }

         var7 = this.mx.ci();
         if (var7 != 0) {
            Logger.debug("  CompressedSize: " + var7);
         }
         ...
         this.mx = SaveFileMetadata.am(var3);
      }
   ...
   byte[] ah(int var1) {
      Object var2 = new FileInputStream(new File(SteamSaveLocation.AboutDialog(this.mt), this.filename));
   ...
   void writeSaveFile(String var1, GameMode var2, String var3, String var4) {
      ...
      File var9 = new File(AppSettings.cG, var8);
   ...
   void updateSaveData(JsonObject var1, boolean var2) {
      ...
      try {
         JsonWriter var6 = new JsonWriter(var3, 2);
      ...
      int var36 = 0;
      Object var37 = new FileOutputStream(new File(SteamSaveLocation.AboutDialog(this.mt), this.filename));
      ...
      if (!this.mx.ce()) {
         Logger.warn("Metadata version could not be upgraded");
      }
      ...
      if (!var2) {
         try {
            ...
            var8 = SteamSaveLocation.d(var7, var35);
         } catch (NoSuchAlgorithmException var31) {
            Logger.AboutDialog("Error generating SHA-256 hash", var31);
         }
      }
      ...
      FileOutputStream var38 = new FileOutputStream(new File(SteamSaveLocation.AboutDialog(this.mt), "mf_" + this.filename));

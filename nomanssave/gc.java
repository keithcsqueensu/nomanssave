...
public class gc {
   ...
   public static String readGuid(InputStream var0) {
   ...
   private static String h(byte[] var0) {
      ...
      appendByteHex(var0[3], var1);
      appendByteHex(var0[2], var1);
      appendByteHex(var0[1], var1);
      appendByteHex(var0[0], var1);
      appendByteHex(var0[5], var1);
      appendByteHex(var0[4], var1);
      appendByteHex(var0[7], var1);
      appendByteHex(var0[6], var1);
      appendByteHex(var0[8], var1);
      appendByteHex(var0[9], var1);
      appendByteHex(var0[10], var1);
      appendByteHex(var0[11], var1);
      appendByteHex(var0[12], var1);
      appendByteHex(var0[13], var1);
      appendByteHex(var0[14], var1);
      appendByteHex(var0[15], var1);
      return var1.toString();
   }

   private static void appendByteHex(byte var0, StringBuilder var1) {
      int var2 = (240 & var0) >> 4;
      int var3 = 15 & var0;
   ...
   public static void writeGuid(OutputStream var0, String var1) {
      if (var1.length() > 32) {
   ...
   public static long readFileTime(InputStream var0) {
      return hk.f(var0) / 10000L + -11644473600000L;
   }

   public static void writeFileTime(OutputStream var0, long var1) {
      hk.writeLong(var0, (var1 - -11644473600000L) * 10000L);
   }

   public static String readUtf16String(InputStream var0) {
   ...
   public static void writeUtf16String(OutputStream var0, String var1) {
      hk.writeInt(var0, var1.length());
   ...
   public static void writeUtf8FixedString(OutputStream var0, String var1) {

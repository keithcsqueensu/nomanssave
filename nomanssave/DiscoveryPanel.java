...
public class DiscoveryPanel extends JPanel {
   ...
   DiscoveryPanel(Application var1) {
      ...
      for(int var20 = 0; var20 < 16; ++var20) {
         ...
         ImageIcon var23 = Application.loadIcon("UI-GLYPH" + (var20 + 1) + ".PNG");
         if (var23 == null) {
   ...
   public void AboutDialog(Exosuit var1) {
      ...
      if (this.cr != null) {
         for(var2 = 0; var2 < this.cr.size(); ++var2) {
            var3 = this.cr.CompanionsPanel(var2);
      ...
      if (this.cs != null) {
         for(var2 = 0; var2 < this.cs.size(); ++var2) {
            var3 = this.cs.CompanionsPanel(var2);
            if (!this.ct.contains(var3)) {
               this.ct.add(var3);
            }
         }
   ...
   // $FF: synthetic method
   static ArrayList d(DiscoveryPanel var0) {
      return var0.ct;
   }

   // $FF: synthetic method
   static JsonArray e(DiscoveryPanel var0) {
      return var0.cs;
   }

   // $FF: synthetic method
   static JsonArray f(DiscoveryPanel var0) {
      return var0.cr;
   }

   // $FF: synthetic method
   static TableRowSorter g(DiscoveryPanel var0) {
      return var0.cl;
   }

   // $FF: synthetic method
   static JTable h(DiscoveryPanel var0) {
      return var0.ck;
   }

   // $FF: synthetic method
   static Exosuit i(DiscoveryPanel var0) {
      return var0.cp;
   }

   // $FF: synthetic method
   static JTable j(DiscoveryPanel var0) {
      return var0.cn;
   }

   // $FF: synthetic method
   static void k(DiscoveryPanel var0) {
      var0.R();
   }
}

...
public class eC {
   ...
   private static eD AccountPanel(String var0, String var1) {
      ...
      if (var2 == null) {
         ...
         try {
            ...
            Logger.error("Could not load key mapping file: " + var0, var4);
            return null;
         }
      }
   }
   ...
   public String q(String var1) {
      ...
      if ((var3 = this.jU.t(var1)) != null) {
         ...
         if ((var3 = this.jT.RefreshRunnable(var1)) != null) {
            var2 = var3.name;
         } else {
            Logger.warn("  name mapping not found: " + var1);
            var2 = var1;
         }
   ...
   public String r(String var1) {
      ...
      if ((var3 = this.jU.u(var1)) != null) {
         ...
         if (this.jT.t(var1) == null) {
            Logger.warn("  reverse mapping not found: " + var1);
         }
      }

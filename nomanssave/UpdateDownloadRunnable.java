...
class UpdateDownloadRunnable implements Runnable {
   // $FF: synthetic field
   final UpdateCheckThread bb;
   // $FF: synthetic field
   private final boolean FormPanel;

   UpdateDownloadRunnable(UpdateCheckThread var1, boolean var2) {
      this.bb = var1;
      this.FormPanel = var2;
   }
   ...
   public void run() {
      ...
      if (!this.FormPanel) {
         ...
         JOptionPane.showOptionDialog(Application.h(UpdateCheckThread.AboutDialog(this.bb)), var1, "New Version Available", 0, 1, (Icon)null, new Object[]{"OK"}, (Object)null);
      } else {
         var1 = var1 + "Would you like to download and install? (will require app restart)";
         int var2 = JOptionPane.showConfirmDialog(Application.h(UpdateCheckThread.AboutDialog(this.bb)), var1, "New Version Available", 0);
         if (var2 == 0) {
            Application.h(UpdateCheckThread.AboutDialog(this.bb)).dispose();
